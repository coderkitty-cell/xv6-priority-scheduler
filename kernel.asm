...
8010168e:	e8 6d 30 00 00       	call   80104700 <memset>
      dip->type = type;
...
8010175f:	e8 dc 2e 00 00       	call   80104640 <acquire>
  ip->ref++;
80101764:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101768:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
8010176f:	e8 6c 2e 00 00       	call   801045e0 <release>
}
...
801017a2:	e8 d9 2b 00 00       	call   80104380 <acquiresleep>
  if(ip->valid == 0){
...
80101818:	e8 83 2f 00 00       	call   801047a0 <memmove>
    brelse(bp);
...
80101873:	e8 a8 2b 00 00       	call   80104420 <holdingsleep>
...
8010188e:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
8010188f:	e9 4c 2b 00 00       	jmp    801043e0 <releasesleep>
    panic("iunlock");
...
801018c0:	e8 bb 2a 00 00       	call   80104380 <acquiresleep>
...
801018da:	e8 01 2b 00 00       	call   801043e0 <releasesleep>
  acquire(&icache.lock);
801018df:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
801018e6:	e8 55 2d 00 00       	call   80104640 <acquire>
  ip->ref--;
...
801018ff:	5d                   	pop    %ebp
  release(&icache.lock);
80101900:	e9 db 2c 00 00       	jmp    801045e0 <release>
80101905:	8d 76 00             	lea    0x0(%esi),%esi
    acquire(&icache.lock);
80101908:	83 ec 0c             	sub    $0xc,%esp
8010190b:	68 60 f9 10 80       	push   $0x8010f960
80101910:	e8 2b 2d 00 00       	call   80104640 <acquire>
    int r = ip->ref;
80101915:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101918:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
8010191f:	e8 bc 2c 00 00       	call   801045e0 <release>
    if(r == 1){
...
80101a23:	e8 f8 29 00 00       	call   80104420 <holdingsleep>
...
80101a3a:	e8 a1 29 00 00       	call   801043e0 <releasesleep>
  iput(ip);
...
80101b37:	e8 64 2c 00 00       	call   801047a0 <memmove>
    brelse(bp);
...
80101c33:	e8 68 2b 00 00       	call   801047a0 <memmove>
    log_write(bp);
...
80101dba:	e8 81 28 00 00       	call   80104640 <acquire>
  ip->ref++;
80101dbf:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101dc3:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
80101dca:	e8 11 28 00 00       	call   801045e0 <release>
...
80101e8c:	e8 8f 25 00 00       	call   80104420 <holdingsleep>
...
80101eae:	e8 2d 25 00 00       	call   801043e0 <releasesleep>
  iput(ip);
...
80101f2b:	e8 f0 24 00 00       	call   80104420 <holdingsleep>
...
80101f4a:	e8 91 24 00 00       	call   801043e0 <releasesleep>
  iput(ip);
...
80101f6d:	e8 ae 24 00 00       	call   80104420 <holdingsleep>
...
80101f90:	e8 8b 24 00 00       	call   80104420 <holdingsleep>
...
80101fa7:	e8 34 24 00 00       	call   801043e0 <releasesleep>
}
...
8010203d:	e8 1e 28 00 00       	call   80104860 <strncpy>
...
801021d0:	e8 9b 22 00 00       	call   80104470 <initlock>
...
8010224e:	e8 ed 23 00 00       	call   80104640 <acquire>
...
801022cb:	e8 10 23 00 00       	call   801045e0 <release>
...
801022ee:	e8 2d 21 00 00       	call   80104420 <holdingsleep>
...
80102328:	e8 13 23 00 00       	call   80104640 <acquire>
...
80102385:	c9                   	leave  
  release(&idelock);
80102386:	e9 55 22 00 00       	jmp    801045e0 <release>
...
801024f2:	e8 09 22 00 00       	call   80104700 <memset>
...
80102528:	e8 13 21 00 00       	call   80104640 <acquire>
...
80102542:	c9                   	leave  
    release(&kmem.lock);
80102543:	e9 98 20 00 00       	jmp    801045e0 <release>
    panic("kfree");
...
80102625:	e8 46 1e 00 00       	call   80104470 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
801026b3:	e8 88 1f 00 00       	call   80104640 <acquire>
  r = kmem.freelist;
...
801026e1:	e8 fa 1e 00 00       	call   801045e0 <release>
  return (char*)r;
...
80102af7:	e8 54 1c 00 00       	call   80104750 <memcmp>
...
80102c24:	e8 77 1b 00 00       	call   801047a0 <memmove>
...
80102cd4:	e8 97 17 00 00       	call   80104470 <initlock>
  readsb(dev, &sb);
80102cd9:	58                   	pop    %eax
...
80102d6b:	e8 d0 18 00 00       	call   80104640 <acquire>
...
80102dbc:	e8 1f 18 00 00       	call   801045e0 <release>
      break;
    }
  }
}
...
80102dde:	e8 5d 18 00 00       	call   80104640 <acquire>
  log.outstanding -= 1;
...
80102e1c:	e8 bf 17 00 00       	call   801045e0 <release>
}
...
80102e36:	e8 05 18 00 00       	call   80104640 <acquire>
    wakeup(&log);
...
80102e58:	e8 83 17 00 00       	call   801045e0 <release>
...
80102eb4:	e8 e7 18 00 00       	call   801047a0 <memmove>
...
80102f14:	e8 c7 16 00 00       	call   801045e0 <release>
...
80102f76:	e8 c5 16 00 00       	call   80104640 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102fb4:	c9                   	leave  
  release(&log.lock);
80102fb5:	e9 26 16 00 00       	jmp    801045e0 <release>
...
801030d4:	e8 c7 16 00 00       	call   801047a0 <memmove>
...
801031c4:	e8 87 15 00 00       	call   80104750 <memcmp>
...
8010327c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
8010327f:	e8 cc 14 00 00       	call   80104750 <memcmp>
...
801034a9:	e8 c2 0f 00 00       	call   80104470 <initlock>
  (*f0)->type = FD_PIPE;
...
8010353f:	e8 fc 10 00 00       	call   80104640 <acquire>
  if(writable){
...
80103583:	5d                   	pop    %ebp
    release(&p->lock);
80103584:	e9 57 10 00 00       	jmp    801045e0 <release>
80103589:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    release(&p->lock);
80103590:	83 ec 0c             	sub    $0xc,%esp
80103593:	53                   	push   %ebx
80103594:	e8 47 10 00 00       	call   801045e0 <release>
    kfree((char*)p);
...
801035dd:	e8 5e 10 00 00       	call   80104640 <acquire>
  for(i = 0; i < n; i++){
...
8010366c:	e8 6f 0f 00 00       	call   801045e0 <release>
        return -1;
...
801036c2:	e8 19 0f 00 00       	call   801045e0 <release>
  return n;
...
801036e6:	e8 55 0f 00 00       	call   80104640 <acquire>
...
8010377e:	e8 5d 0e 00 00       	call   801045e0 <release>
  return i;
...
80103799:	e8 42 0e 00 00       	call   801045e0 <release>
      return -1;
...
801037c1:	e8 7a 0e 00 00       	call   80104640 <acquire>
...
80103807:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
8010380d:	e8 ce 0d 00 00       	call   801045e0 <release>
...
8010382f:	89 53 1c             	mov    %edx,0x1c(%ebx)
  *(uint*)sp = (uint)trapret;
80103832:	c7 40 14 4f 59 10 80 	movl   $0x8010594f,0x14(%eax)
  p->context = (struct context*)sp;
...
80103841:	e8 ba 0e 00 00       	call   80104700 <memset>
...
801039c3:	e8 78 35 00 00       	call   80106f40 <setupkvm>
...
801039e1:	e8 0a 32 00 00       	call   80106bf0 <inituvm>
...
80103acb:	e8 10 30 00 00       	call   80106ae0 <switchuvm>
  return 0;
...
80103aea:	e8 71 32 00 00       	call   80106d60 <allocuvm>
...
80103b0a:	e8 81 33 00 00       	call   80106e90 <deallocuvm>
...
80103b58:	e8 d3 34 00 00       	call   80107030 <copyuvm>
...
80103b75:	89 02                	mov    %eax,(%edx)
  *np->tf = *curproc->tf;
80103b77:	8b 7a 1c             	mov    0x1c(%edx),%edi
  np->parent = curproc;
80103b7a:	89 5a 18             	mov    %ebx,0x18(%edx)
  *np->tf = *curproc->tf;
80103b7d:	8b 73 1c             	mov    0x1c(%ebx),%esi
80103b80:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  for(i = 0; i < NOFILE; i++)
80103b82:	31 f6                	xor    %esi,%esi
  np->priority = curproc->priority;
80103b84:	8b 43 14             	mov    0x14(%ebx),%eax
80103b87:	89 42 14             	mov    %eax,0x14(%edx)
  np->tf->eax = 0;
80103b8a:	8b 42 1c             	mov    0x1c(%edx),%eax
...
80103bbe:	ff 73 6c             	push   0x6c(%ebx)
...
80103c6b:	e8 d0 09 00 00       	call   80104640 <acquire>
80103c70:	83 c4 10             	add    $0x10,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c73:	b8 54 1d 11 80       	mov    $0x80111d54,%eax
80103c78:	eb 19                	jmp    80103c93 <scheduler+0x53>
80103c7a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      if(!best || p->priority > best->priority)
80103c80:	8b 57 14             	mov    0x14(%edi),%edx
80103c83:	39 50 14             	cmp    %edx,0x14(%eax)
80103c86:	0f 4f f8             	cmovg  %eax,%edi
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c89:	83 e8 80             	sub    $0xffffff80,%eax
80103c8c:	3d 54 3d 11 80       	cmp    $0x80113d54,%eax
80103c91:	74 1d                	je     80103cb0 <scheduler+0x70>
      if(p->state != RUNNABLE)
80103c93:	83 78 0c 03          	cmpl   $0x3,0xc(%eax)
80103c97:	75 f0                	jne    80103c89 <scheduler+0x49>
      if(!best || p->priority > best->priority)
80103c99:	85 ff                	test   %edi,%edi
80103c9b:	75 e3                	jne    80103c80 <scheduler+0x40>
80103c9d:	89 c7                	mov    %eax,%edi
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c9f:	83 e8 80             	sub    $0xffffff80,%eax
80103ca2:	3d 54 3d 11 80       	cmp    $0x80113d54,%eax
80103ca7:	75 ea                	jne    80103c93 <scheduler+0x53>
80103ca9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(best){
80103cb0:	85 ff                	test   %edi,%edi
80103cb2:	74 33                	je     80103ce7 <scheduler+0xa7>
      switchuvm(p);
80103cb4:	83 ec 0c             	sub    $0xc,%esp
      c->proc = p;
80103cb7:	89 bb ac 00 00 00    	mov    %edi,0xac(%ebx)
      switchuvm(p);
80103cbd:	57                   	push   %edi
80103cbe:	e8 1d 2e 00 00       	call   80106ae0 <switchuvm>
      p->state = RUNNING;
80103cc3:	c7 47 0c 04 00 00 00 	movl   $0x4,0xc(%edi)
      swtch(&(c->scheduler), p->context);
80103cca:	58                   	pop    %eax
80103ccb:	5a                   	pop    %edx
80103ccc:	ff 77 20             	push   0x20(%edi)
80103ccf:	56                   	push   %esi
80103cd0:	e8 46 0c 00 00       	call   8010491b <swtch>
      switchkvm();
80103cd5:	e8 f6 2d 00 00       	call   80106ad0 <switchkvm>
      c->proc = 0;
...
80103cf7:	e9 64 ff ff ff       	jmp    80103c60 <scheduler+0x20>
...
80103d63:	e8 b3 0b 00 00       	call   8010491b <swtch>
  mycpu()->intena = intena;
...
80103e2a:	e8 11 08 00 00       	call   80104640 <acquire>
...
80103ecd:	68 68 78 10 80       	push   $0x80107868
80103ed2:	e8 a9 c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103ed7:	83 ec 0c             	sub    $0xc,%esp
80103eda:	68 5b 78 10 80       	push   $0x8010785b
...
80103f5b:	0f 85 95 00 00 00    	jne    80103ff6 <wait+0x106>
  pushcli();
80103f61:	e8 8a 05 00 00       	call   801044f0 <pushcli>
  c = mycpu();
80103f66:	e8 95 f9 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103f6b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f71:	e8 ca 05 00 00       	call   80104540 <popcli>
  if(p == 0)
...
80103fe5:	e8 f6 05 00 00       	call   801045e0 <release>
        return pid;
...
80104003:	e8 d8 05 00 00       	call   801045e0 <release>
      return -1;
...
8010402c:	e8 0f 06 00 00       	call   80104640 <acquire>
  pushcli();
80104031:	e8 ba 04 00 00       	call   801044f0 <pushcli>
  c = mycpu();
80104036:	e8 c5 f8 ff ff       	call   80103900 <mycpu>
  p = c->proc;
8010403b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104041:	e8 fa 04 00 00       	call   80104540 <popcli>
...
80104059:	e8 82 05 00 00       	call   801045e0 <release>
}
...
8010407c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
8010407f:	e8 6c 04 00 00       	call   801044f0 <pushcli>
  c = mycpu();
80104084:	e8 77 f8 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80104089:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010408f:	e8 ac 04 00 00       	call   80104540 <popcli>
  if(p == 0)
...
80104119:	68 7a 78 10 80       	push   $0x8010787a
8010411e:	e8 5d c2 ff ff       	call   80100380 <panic>
    panic("sleep");
80104123:	83 ec 0c             	sub    $0xc,%esp
80104126:	68 74 78 10 80       	push   $0x80107874
...
8010413f:	e8 fc 04 00 00       	call   80104640 <acquire>
...
80104160:	3b 58 24             	cmp    0x24(%eax),%ebx
...
80104180:	c9                   	leave  
  release(&ptable.lock);
80104181:	e9 5a 04 00 00       	jmp    801045e0 <release>
...
8010419f:	e8 9c 04 00 00       	call   80104640 <acquire>
...
801041bf:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
      p->killed = 1;
801041c3:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
      if(p->state == SLEEPING)
...
801041db:	e8 00 04 00 00       	call   801045e0 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
8010421f:	e8 1c 04 00 00       	call   80104640 <acquire>
80104224:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104227:	b8 54 1d 11 80       	mov    $0x80111d54,%eax
8010422c:	eb 0c                	jmp    8010423a <setpriority+0x2a>
8010422e:	66 90                	xchg   %ax,%ax
80104230:	83 e8 80             	sub    $0xffffff80,%eax
80104233:	3d 54 3d 11 80       	cmp    $0x80113d54,%eax
80104238:	74 26                	je     80104260 <setpriority+0x50>
    if(p->pid == pid){
8010423a:	39 58 10             	cmp    %ebx,0x10(%eax)
8010423d:	75 f1                	jne    80104230 <setpriority+0x20>
      p->priority = priority;
...
8010424d:	e8 8e 03 00 00       	call   801045e0 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
80104289:	bb c4 1d 11 80       	mov    $0x80111dc4,%ebx
...
8010431d:	68 e1 72 10 80       	push   $0x801072e1
...
8010434a:	68 04 79 10 80       	push   $0x80107904
...
801043a5:	e8 c6 fc ff ff       	call   80104070 <sleep>
  while (lk->locked) {
...
80104404:	e8 27 fd ff ff       	call   80104130 <wakeup>
  release(&lk->lk);
...
80104585:	68 0f 79 10 80       	push   $0x8010790f
8010458a:	e8 f1 bd ff ff       	call   80100380 <panic>
    panic("popcli");
8010458f:	83 ec 0c             	sub    $0xc,%esp
80104592:	68 26 79 10 80       	push   $0x80107926
...
801045fb:	68 2d 79 10 80       	push   $0x8010792d
...
801046f0:	68 35 79 10 80       	push   $0x80107935
...
80104a28:	8b 40 1c             	mov    0x1c(%eax),%eax
...
80104b00 <syscall>:
  [SYS_setpriority] sys_setpriority,  // <- added new syscall
};
...
80104b0c:	89 c3                	mov    %eax,%ebx
  ...
  num = curproc->tf->eax;
80104b0e:	8b 40 1c             	mov    0x1c(%eax),%eax
...
80104b48:	68 3d 79 10 80       	push   $0x8010793d
80104b4d:	e8 4e bb ff ff       	call   801006a0 <cprintf>
    curproc->tf->eax = -1;
80104b52:	8b 43 1c             	mov    0x1c(%ebx),%eax
...
80104ca4:	68 d8 79 10 80       	push   $0x801079d8
...
80104cbc:	68 d7 79 10 80       	push   $0x801079d7
...
80104cd1:	68 cb 79 10 80       	push   $0x801079cb
...
80104cef:	68 da 79 10 80       	push   $0x801079da
80104cf4:	e8 87 b6 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104cf9:	83 ec 0c             	sub    $0xc,%esp
80104cfc:	68 bc 79 10 80       	push   $0x801079bc
...
80104d1e:	e8 9d fc ff ff       	call   801049c0 <argint>
...
80104d50:	8b 54 98 2c          	mov    0x2c(%eax,%ebx,4),%edx
...
80104d70:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
80104d73:	89 74 98 2c          	mov    %esi,0x2c(%eax,%ebx,4)
  filedup(f);
...
80104d9e:	e8 1d fc ff ff       	call   801049c0 <argint>
...
80104dc9:	e8 f2 fb ff ff       	call   801049c0 <argint>
...
80104e1e:	e8 9d fb ff ff       	call   801049c0 <argint>
...
80104e38:	8b 74 90 2c          	mov    0x2c(%eax,%edx,4),%esi
...
80104e49:	e8 72 fb ff ff       	call   801049c0 <argint>
...
80104e9e:	e8 1d fb ff ff       	call   801049c0 <argint>
...
80104ebb:	8b 74 98 0c          	mov    0xc(%eax,%ebx,4),%esi
...
80104ec8:	83 ec 0c             	sub    $0xc,%esp
  myproc()->ofile[fd] = 0;
80104ecb:	c7 44 98 0c 00 00 00 	movl   $0x0,0xc(%eax,%ebx,4)
80104ed2:	00 
  fileclose(f);
...
801050fd:	58                   	pop    %eax
801050fe:	5a                   	pop    %edx
801050ff:	68 d8 79 10 80       	push   $0x801079d8
...
80105118:	68 d7 79 10 80       	push   $0x801079d7
...
80105172:	e8 89 f5 ff ff       	call   80104700 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
801052b8:	e8 03 f7 ff ff       	call   801049c0 <argint>
...
8010530e:	31 db                	xor    %ebx,%ebx
    if(curproc->ofile[fd] == 0){
80105310:	8b 54 98 2c          	mov    0x2c(%eax,%ebx,4),%edx
...
80105378:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
8010537b:	89 7c 98 2c          	mov    %edi,0x2c(%eax,%ebx,4)
  iunlock(ip);
...
80105459:	e8 62 f5 ff ff       	call   801049c0 <argint>
  if((argstr(0, &path)) < 0 ||
...
8010546e:	e8 4d f5 ff ff       	call   801049c0 <argint>
     argint(1, &major) < 0 ||
...
801055a1:	e8 1a f4 ff ff       	call   801049c0 <argint>
...
801055c0:	e8 3b f1 ff ff       	call   80104700 <memset>
...
801055ea:	e8 41 f3 ff ff       	call   80104930 <fetchint>
...
80105608:	e8 63 f3 ff ff       	call   80104970 <fetchstr>
...
8010569e:	66 90                	xchg   %ax,%ax
    if(curproc->ofile[fd] == 0){
801056a0:	8b 74 98 2c          	mov    0x2c(%eax,%ebx,4),%esi
...
801056e1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(curproc->ofile[fd] == 0){
801056e8:	8b 4c 90 2c          	mov    0x2c(%eax,%edx,4),%ecx
...
8010570e:	66 90                	xchg   %ax,%ax
      curproc->ofile[fd] = f;
80105710:	89 7c 90 2c          	mov    %edi,0x2c(%eax,%edx,4)
  }
  fd[0] = fd0;
...
80105743:	83 ec 08             	sub    $0x8,%esp
  exit();
80105746:	e8 75 e6 ff ff       	call   80103dc0 <exit>
...
{
  return wait();
80105750:	e9 9b e7 ff ff       	jmp    80103ef0 <wait>
...
8010576c:	e8 4f f2 ff ff       	call   801049c0 <argint>
...
8010577e:	e8 0d ea ff ff       	call   80104190 <kill>
...
801057bd:	e8 fe f1 ff ff       	call   801049c0 <argint>
...
8010580d:	e8 ae f1 ff ff       	call   801049c0 <argint>
...
80105820:	68 80 3d 11 80       	push   $0x80113d80
80105825:	e8 16 ee ff ff       	call   80104640 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010582a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
8010582d:	8b 1d 60 3d 11 80    	mov    0x80113d60,%ebx
  while(ticks - ticks0 < n){
...
80105843:	68 80 3d 11 80       	push   $0x80113d80
80105848:	68 60 3d 11 80       	push   $0x80113d60
8010584d:	e8 1e e8 ff ff       	call   80104070 <sleep>
  while(ticks - ticks0 < n){
80105852:	a1 60 3d 11 80       	mov    0x80113d60,%eax
...
80105870:	68 80 3d 11 80       	push   $0x80113d80
80105875:	e8 66 ed ff ff       	call   801045e0 <release>
  }
  release(&tickslock);
  return 0;
}
...
80105893:	68 80 3d 11 80       	push   $0x80113d80
80105898:	e8 43 ed ff ff       	call   801045e0 <release>
  return 0;
...
801058b4:	83 ec 10             	sub    $0x10,%esp
  uint xticks;
  acquire(&tickslock);
801058b7:	68 80 3d 11 80       	push   $0x80113d80
801058bc:	e8 7f ed ff ff       	call   80104640 <acquire>
  xticks = ticks;
801058c1:	8b 1d 60 3d 11 80    	mov    0x80113d60,%ebx
  release(&tickslock);
801058c7:	c7 04 24 80 3d 11 80 	movl   $0x80113d80,(%esp)
801058ce:	e8 0d ed ff ff       	call   801045e0 <release>
  return xticks;
}
...
801058ec:	e8 cf f0 ff ff       	call   801049c0 <argint>
801058f1:	83 c4 10             	add    $0x10,%esp
801058f4:	85 c0                	test   %eax,%eax
801058f6:	78 38                	js     80105930 <sys_setpriority+0x50>
    return -1;
  if(argint(1, &pr) < 0)
...
80105901:	e8 ba f0 ff ff       	call   801049c0 <argint>
80105906:	83 c4 10             	add    $0x10,%esp
80105909:	85 c0                	test   %eax,%eax
8010590b:	78 23                	js     80105930 <sys_setpriority+0x50>
    return -1;

  if(pr < 1 || pr > 10)
8010590d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105910:	8d 50 ff             	lea    -0x1(%eax),%edx
80105913:	83 fa 09             	cmp    $0x9,%edx
80105916:	77 18                	ja     80105930 <sys_setpriority+0x50>
    return -1;
...
8010591f:	e8 ec e8 ff ff       	call   80104210 <setpriority>
...
80105977:	c7 04 c5 c2 3d 11 80 	movl   $0x8e000008,-0x7feec23e(,%eax,8)
8010597e:	08 00 00 8e 
80105982:	66 89 14 c5 c0 3d 11 	mov    %dx,-0x7feec240(,%eax,8)
80105989:	80 
8010598a:	c1 ea 10             	shr    $0x10,%edx
8010598d:	66 89 14 c5 c6 3d 11 	mov    %dx,-0x7feec23a(,%eax,8)
80105994:	80 
  for(i = 0; i < 256; i++)
...
801059a7:	c7 05 c2 3f 11 80 08 	movl   $0xef000008,0x80113fc2
801059ae:	00 00 ef 
  initlock(&tickslock, "time");
801059b1:	68 1d 7a 10 80       	push   $0x80107a1d
801059b6:	68 80 3d 11 80       	push   $0x80113d80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801059bb:	66 a3 c0 3f 11 80    	mov    %ax,0x80113fc0
801059c1:	c1 e8 10             	shr    $0x10,%eax
801059c4:	66 a3 c6 3f 11 80    	mov    %ax,0x80113fc6
  initlock(&tickslock, "time");
...
801059eb:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801059ef:	b8 c0 3d 11 80       	mov    $0x80113dc0,%eax
...
80105a34:	ff 24 85 c4 7a 10 80 	jmp    *-0x7fef853c(,%eax,4)
...
80105ae0:	e8 7b de ff ff       	call   80103960 <cpuid>
...
80105b44:	0f 85 3e ff ff ff    	jne    80105a88 <trap+0x78>
    yield();
80105b4a:	e8 d1 e4 ff ff       	call   80104020 <yield>
...
80105b5f:	e8 fc dd ff ff       	call   80103960 <cpuid>
80105b64:	57                   	push   %edi
80105b65:	56                   	push   %esi
80105b66:	50                   	push   %eax
80105b67:	68 28 7a 10 80       	push   $0x80107a28
...
80105b8f:	90                   	nop
    if(myproc()->killed)
80105b90:	e8 eb dd ff ff       	call   80103980 <myproc>
80105b95:	8b 70 28             	mov    0x28(%eax),%esi
...
80105ba5:	89 58 1c             	mov    %ebx,0x1c(%eax)
    syscall();
80105ba8:	e8 53 ef ff ff       	call   80104b00 <syscall>
    if(myproc()->killed)
80105bad:	e8 ce dd ff ff       	call   80103980 <myproc>
80105bb2:	8b 48 28             	mov    0x28(%eax),%ecx
...
80105bc3:	5d                   	pop    %ebp
      exit();
80105bc4:	e9 f7 e1 ff ff       	jmp    80103dc0 <exit>
...
80105bf5:	e8 16 cd ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105bfa:	e8 81 dd ff ff       	call   80103980 <myproc>
...
80105c20:	68 80 3d 11 80       	push   $0x80113d80
80105c25:	e8 16 ea ff ff       	call   80104640 <acquire>
      wakeup(&ticks);
80105c2a:	c7 04 24 60 3d 11 80 	movl   $0x80113d60,(%esp)
      ticks++;
80105c31:	83 05 60 3d 11 80 01 	addl   $0x1,0x80113d60
      wakeup(&ticks);
80105c38:	e8 f3 e4 ff ff       	call   80104130 <wakeup>
      release(&tickslock);
80105c3d:	c7 04 24 80 3d 11 80 	movl   $0x80113d80,(%esp)
80105c44:	e8 97 e9 ff ff       	call   801045e0 <release>
...
{
  if(!uart)
80105ca0:	a1 c0 45 11 80       	mov    0x801145c0,%eax
...
80105d27:	74 78                	je     80105da1 <uartinit+0xd1>
  uart = 1;
80105d29:	c7 05 c0 45 11 80 01 	movl   $0x1,0x801145c0
80105d30:	00 00 00 
...
801069e5:	e8 16 dd ff ff       	call   80104700 <memset>
...
80106a43:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106a46:	e8 15 cf ff ff       	call   80103960 <cpuid>
  pd[0] = size-1;
...
80106ad0:	a1 c4 45 11 80       	mov    0x801145c4,%eax
...
80106b04:	0f 84 c2 00 00 00    	je     80106bcc <switchuvm+0xec>
  pushcli();
80106b0a:	e8 e1 d9 ff ff       	call   801044f0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106b0f:	e8 ec cd ff ff       	call   80103900 <mycpu>
80106b14:	89 c3                	mov    %eax,%ebx
80106b16:	e8 e5 cd ff ff       	call   80103900 <mycpu>
...
80106b28:	e8 d3 cd ff ff       	call   80103900 <mycpu>
...
80106b71:	e8 8a cd ff ff       	call   80103900 <mycpu>
...
80106b94:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106b97:	e8 64 cd ff ff       	call   80103900 <mycpu>
...
80106bb9:	5d                   	pop    %ebp
  popcli();
80106bba:	e9 81 d9 ff ff       	jmp    80104540 <popcli>
...
80106c1f:	e8 dc da ff ff       	call   80104700 <memset>
...
80106c52:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106c53:	e9 48 db ff ff       	jmp    801047a0 <memmove>
...
80106f60:	e8 9b d7 ff ff       	call   80104700 <memset>
...
80106fcb:	a3 c4 45 11 80       	mov    %eax,0x801145c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80107200:	e8 9b d5 ff ff       	call   801047a0 <memmove>
    len -= n;
    buf += n;
