...
_edge_priority:     file format elf32-i386
...
int main() {
  ...
  12:	68 28 08 00 00       	push   $0x828
  17:	6a 01                	push   $0x1
  19:	e8 e2 04 00 00       	call   500 <printf>

    int pid;

    // Test 1: Negative priority
    pid = fork();
  1e:	e8 78 03 00 00       	call   39b <fork>
    if(pid == 0) {
  23:	83 c4 10             	add    $0x10,%esp
  26:	85 c0                	test   %eax,%eax
  28:	75 7d                	jne    a7 <main+0xa7>
  ...
  33:	6a 01                	push   $0x1
  35:	e8 c6 04 00 00       	call   500 <printf>
        if(setpriority(getpid(), -5) < 0)
  3a:	e8 e4 03 00 00       	call   423 <getpid>
  3f:	5a                   	pop    %edx
  40:	59                   	pop    %ecx
  41:	6a fb                	push   $0xfffffffb
  43:	50                   	push   %eax
  44:	e8 fa 03 00 00       	call   443 <setpriority>
  49:	83 c4 10             	add    $0x10,%esp
  4c:	85 c0                	test   %eax,%eax
  4e:	78 44                	js     94 <main+0x94>
  ...
  57:	6a 01                	push   $0x1
  59:	e8 a2 04 00 00       	call   500 <printf>
  ...
  6e:	53                   	push   %ebx
  6f:	68 cc 08 00 00       	push   $0x8cc
  74:	6a 01                	push   $0x1
  76:	e8 85 04 00 00       	call   500 <printf>
            sleep(1);
  7b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  82:	e8 ac 03 00 00       	call   433 <sleep>
        for(int i = 0; i < RUNS; i++) {
  87:	83 c4 10             	add    $0x10,%esp
  8a:	83 fb 03             	cmp    $0x3,%ebx
  8d:	75 d9                	jne    68 <main+0x68>
        }
        exit();
  8f:	e8 0f 03 00 00       	call   3a3 <exit>
            printf(1, "Correct: Failed to set negative priority\n");
  94:	50                   	push   %eax
  95:	50                   	push   %eax
  96:	68 7c 08 00 00       	push   $0x87c
  9b:	6a 01                	push   $0x1
  9d:	e8 5e 04 00 00       	call   500 <printf>
  a2:	83 c4 10             	add    $0x10,%esp
  a5:	eb c1                	jmp    68 <main+0x68>
    }

    // Test 2: Extremely high priority
    pid = fork();
  a7:	e8 ef 02 00 00       	call   39b <fork>
  ac:	89 c3                	mov    %eax,%ebx
    if(pid == 0) {
  ae:	85 c0                	test   %eax,%eax
  b0:	75 6a                	jne    11c <main+0x11c>
        printf(1, "--- Testing extremely high priority ---\n");
  b2:	50                   	push   %eax
  b3:	50                   	push   %eax
  b4:	68 fc 08 00 00       	push   $0x8fc
  b9:	6a 01                	push   $0x1
  bb:	e8 40 04 00 00       	call   500 <printf>
  ...
  c7:	6a 14                	push   $0x14
  c9:	50                   	push   %eax
  ca:	e8 74 03 00 00       	call   443 <setpriority>
  cf:	83 c4 10             	add    $0x10,%esp
  d2:	85 c0                	test   %eax,%eax
  d4:	78 63                	js     139 <main+0x139>
            printf(1, "Correct: Failed to set too-high priority\n");
        else
            printf(1, "Extreme-priority child running\n");
  d6:	52                   	push   %edx
  d7:	52                   	push   %edx
  d8:	68 54 09 00 00       	push   $0x954
  dd:	6a 01                	push   $0x1
  df:	e8 1c 04 00 00       	call   500 <printf>
  ...
  f6:	53                   	push   %ebx
  f7:	68 74 09 00 00       	push   $0x974
  fc:	6a 01                	push   $0x1
  fe:	e8 fd 03 00 00       	call   500 <printf>
            sleep(1);
 103:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 10a:	e8 24 03 00 00       	call   433 <sleep>
        for(int i = 0; i < RUNS; i++) {
 10f:	83 c4 10             	add    $0x10,%esp
 112:	83 fb 03             	cmp    $0x3,%ebx
 115:	75 d9                	jne    f0 <main+0xf0>
 117:	e9 73 ff ff ff       	jmp    8f <main+0x8f>
        }
        exit();
    }
    ...
    wait();
 11c:	e8 8a 02 00 00       	call   3ab <wait>
    wait();
 121:	e8 85 02 00 00       	call   3ab <wait>

    printf(1, "\n=== EDGE-CASE TEST COMPLETE ===\n");
 126:	50                   	push   %eax
 127:	50                   	push   %eax
 128:	68 a4 09 00 00       	push   $0x9a4
 12d:	6a 01                	push   $0x1
 12f:	e8 cc 03 00 00       	call   500 <printf>
    exit();
 134:	e8 6a 02 00 00       	call   3a3 <exit>
            printf(1, "Correct: Failed to set too-high priority\n");
 139:	51                   	push   %ecx
 13a:	51                   	push   %ecx
 13b:	68 28 09 00 00       	push   $0x928
 140:	6a 01                	push   $0x1
 142:	e8 b9 03 00 00       	call   500 <printf>
 147:	83 c4 10             	add    $0x10,%esp
 14a:	eb a4                	jmp    f0 <main+0xf0>
...
SYSCALL(setpriority)    # <-- New system call added
 ...
 45c:	89 d1                	mov    %edx,%ecx
{
 ...
 489:	0f b6 92 28 0a 00 00 	movzbl 0xa28(%edx),%edx
 ...
 509:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 579:	ff 24 85 d0 09 00 00 	jmp    *0x9d0(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 687:	90                   	nop
          s = "(null)";
 688:	ba c6 09 00 00       	mov    $0x9c6,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6a1:	a1 d4 0c 00 00       	mov    0xcd4,%eax
{
 ...
 6e1:	5b                   	pop    %ebx
  freep = p;
 6e2:	89 15 d4 0c 00 00    	mov    %edx,0xcd4
}
 6e8:	5e                   	pop    %esi
 6e9:	5f                   	pop    %edi
 6ea:	5d                   	pop    %ebp
 ...
 719:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 71c:	89 15 d4 0c 00 00    	mov    %edx,0xcd4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 73c:	8b 3d d4 0c 00 00    	mov    0xcd4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 77f:	73 4f                	jae    7d0 <malloc+0xa0>
    ...
    if(p == freep)
 781:	8b 3d d4 0c 00 00    	mov    0xcd4,%edi
 ...
 7aa:	e8 f1 fe ff ff       	call   6a0 <free>
  return freep;
 7af:	8b 15 d4 0c 00 00    	mov    0xcd4,%edx
 ...
 7dc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7df:	89 15 d4 0c 00 00    	mov    %edx,0xcd4
}
 ...
 7ef:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7f0:	c7 05 d4 0c 00 00 d8 	movl   $0xcd8,0xcd4
 7f7:	0c 00 00 
    base.s.size = 0;
 7fa:	bf d8 0c 00 00       	mov    $0xcd8,%edi
    base.s.ptr = freep = prevp = &base;
 7ff:	c7 05 d8 0c 00 00 d8 	movl   $0xcd8,0xcd8
 806:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 809:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 80b:	c7 05 dc 0c 00 00 00 	movl   $0x0,0xcdc
 812:	00 00 00 
    if(p->s.size >= nunits){
